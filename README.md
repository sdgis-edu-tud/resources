...
- [3D](#3d)
  ...
  - [VR/AR](#vr-/-ar)
  - [3D Digital Elevation Model](#3d-digital-elevation-model)
- [Networks](#networks)
...
- [AHN 4](https://www.ahn.nl/ahn-4) - AHN 4 version of the Netherlands digital elevation model dataset
### Climate Data
### Open Street Maps
...
- [Geofabrik](http://download.geofabrik.de/) - Provides OpenStreetMap extracts prepared in either PBF or shapefile format for download daily.
